...
int main()
{
	...
	Maze::TileKey gameMap[Maze::HEIGHT][Maze::WIDTH] = {
		{ w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, S, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, S, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		...
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, w, w, w, w, w, w, w, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, w, _, _, _, _, _, _, _, _, _, w, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, w, _, _, w, w, _, w, w, _, _, w, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, w, _, _, w, _, _, _, w, _, _, w, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, w, _, _, _, _, G, _, _, _, _, w, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, w, _, _, w, _, _, _, w, _, _, w, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, w, _, _, w, w, _, w, w, _, _, w, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, w, _, _, _, _, _, _, _, _, _, w, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
	...
	game.setCurrentScene(game.addScene(new Maze(gameMap)));
